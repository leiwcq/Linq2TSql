...
using Linq2TSql.SchemaReader.Conversion.Loaders;
using Linq2TSql.SchemaReader.DataSchema;
using Linq2TSql.SchemaReader.Filters;
using Linq2TSql.SchemaReader.ProviderSchemaReaders;

namespace Linq2TSql.SchemaReader
{
    /// <summary>
    ...
    public class DatabaseReader : IDatabaseReader
    {
        ...
        /// <summary>
        /// Gets the database schema. Only call AFTER calling <see cref="ReadAll"/> or one or more other methods such as <see cref="AllTables"/>. A collection of Tables, Views and StoredProcedures. Use <see cref="DatabaseSchemaFixer.UpdateReferences"/> to update object references after loaded. Use <see cref="DatabaseSchemaFixer.UpdateDataTypes"/> to add datatypes from DbDataType string after loaded.
        /// </summary>
        ...
        public IList<DatabaseTable> AllTables()
        {
            ...
            tables.Sort((t1, t2) => string.Compare(t1.Name, t2.Name, StringComparison.OrdinalIgnoreCase));
        ...
        public IList<DatabaseStoredProcedure> AllStoredProcedures()
        {
            ...
            {
                PackageFilter = Exclusions.PackageFilter,
                StoredProcedureFilter = Exclusions.StoredProcedureFilter
            };
