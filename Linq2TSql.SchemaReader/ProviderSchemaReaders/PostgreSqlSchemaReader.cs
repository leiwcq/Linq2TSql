...
INNER JOIN pg_language lng ON lng.oid = pr.prolang
 ...
 ORDER BY pr.proname";
        ...
        public override void PostProcessing(DatabaseTable databaseTable)
        {
            ...
            var typeWriter = new SqlGen.PostgreSql.DataTypeWriter();
        ...
        public override List<DataType> SchemaDataTypes()
        {
            ...
            {
                new DataType("bigint", typeof (long).FullName),
                new DataType("bigserial", typeof (long).FullName),
                new DataType("binary", typeof (Byte[]).FullName),
                new DataType("bit varying", typeof (long).FullName),
                new DataType("bit", typeof (long).FullName),
                new DataType("bool", typeof (bool).FullName),
                new DataType("boolean", typeof (bool).FullName),
                new DataType("bytea", typeof (Byte[]).FullName),
                new DataType("char", typeof (string).FullName),
                new DataType("character varying", typeof (string).FullName),
                new DataType("character", typeof (string).FullName),
                new DataType("date", typeof (DateTime).FullName),
                new DataType("dec", typeof (decimal).FullName),
                new DataType("decimal", typeof (decimal).FullName),
                new DataType("double precision", typeof (double).FullName),
                new DataType("double", typeof (double).FullName),
                new DataType("float", typeof (Single).FullName),
                new DataType("float4", typeof (Single).FullName),
                new DataType("int", typeof (int).FullName),
                new DataType("int4", typeof (int).FullName),
                new DataType("int8", typeof (long).FullName),
                new DataType("integer", typeof (int).FullName),
                new DataType("interval", typeof (TimeSpan).FullName),
                new DataType("line", typeof (string).FullName),
                new DataType("money", typeof (double).FullName),
                new DataType("numeric", typeof (decimal).FullName),
                new DataType("real", typeof (Single).FullName),
                new DataType("serial", typeof (int).FullName),
                new DataType("serial4", typeof (int).FullName),
                new DataType("serial8", typeof (long).FullName),
                new DataType("smallint", typeof (short).FullName),
                new DataType("text", typeof (string).FullName),
                new DataType("time", typeof (TimeSpan).FullName),
                new DataType("timestamp", typeof (DateTime).FullName),
                new DataType("timestamptz", typeof (DateTime).FullName),
                new DataType("timetz", typeof (TimeSpan).FullName),
                new DataType("varbit", typeof (long).FullName),
                new DataType("varchar", typeof (string).FullName)
            };
            return list;
        }
